...
async def get_config():
    ...
    return {
        ...
        "transformZones": [
            {"value": "zone_1", "label": "Zone I — Malindi (37°E)", "lon": 37},
            {"value": "zone_2", "label": "Zone II — Nairobi (38°E)", "lon": 38},
            {"value": "zone_3", "label": "Zone III — Nakuru (36°E)", "lon": 36},
            {"value": "zone_4", "label": "Zone IV — Kisumu (35°E)", "lon": 35},
            {"value": "nairobi_local", "label": "Nairobi Local (36.8°E)", "lon": 36.8},
        ],
        "transformMethods": ["geodetic", "polynomial", "helmert"],
